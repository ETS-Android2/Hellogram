...
public class User {
    ...
    public void editProfile() throws NoSuchAlgorithmException, HeadlessException, MessagingException {
        switch (Integer.parseInt(JOptionPane.showInputDialog(null,
            ...
            case 5:
                ...
                if (DataBase.twoFactorAuthentication(newEmail)) {
                    JOptionPane.showMessageDialog(null,
                            "Your Email Address Was Successfully Changed From " + currentEmail + " to " + newEmail,
                            "Edit Profile", JOptionPane.INFORMATION_MESSAGE);

                    new JavaMail().send("Edit Profile", newEmail,
                            "Your Email Address Was Successfully Changed From " + currentEmail + " to " + newEmail);
                    new JavaMail().send("Edit Profile", currentEmail,
                            "Your Email Address Was Successfully Changed From " + currentEmail + " to " + newEmail);

                    setEmail(newEmail);
                } else
                    JOptionPane.showMessageDialog(null, "Edit Profile Operation Was Failed.", "Edit Profile",
    ...
    public static User logIn() throws HeadlessException, NoSuchAlgorithmException, MessagingException {
                ...
                if (username.equals(searchUser.getUsername())) {
                    ...
                    do {
                        ...
                        if (password.equals(searchUser.getPassword())) {
                            if (DataBase.twoFactorAuthentication(searchUser.getEmail())) {
                                JOptionPane.showMessageDialog(null,
                                        "Log-In Was Successful.\nWelcome " + DataBase.getUser(username).getFullName(),
                                        "Log-In Page",
                                        JOptionPane.INFORMATION_MESSAGE);

                                new JavaMail().send("Log-In Attempt", searchUser.getEmail(),
                                        "\nLog-In Attempt Was Successful.\nLog-In Date & Time: "
    ...
    public static User signUp() throws HeadlessException, NoSuchAlgorithmException, MessagingException {
        ...
        String email = JOptionPane.showInputDialog(null, "Please Enter Your Email Address:",
                "Sign-Up Page", JOptionPane.QUESTION_MESSAGE);
        if (DataBase.twoFactorAuthentication(email)) {
            ...
            new JavaMail().send("Welcome to Hellogram!", email,
                    "\nYour Account Has Been Registered Successfully.\nWritten & Developed By AmirHossein Roodaki, Yousof Asadi, Matin Monshizade.");

            return newUser;
        }

        JOptionPane.showMessageDialog(null, "Sign Up Operation Was Failed.", "Sign-Up Page", JOptionPane.ERROR_MESSAGE);
        return null;
