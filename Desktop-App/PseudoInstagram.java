...
public class PseudoInstagram {
	public static void main(String[] args) throws HeadlessException, NoSuchAlgorithmException, MessagingException {
		...
		JOptionPane.showMessageDialog(null,
				"Thanks for Using Pseudo-Instagram Application.\nHope You've Enjoyed.\n\nThis App Was Written & Developed by AmirHossein Roodaki, Yousof Asadu & Matin Monshizade.",
